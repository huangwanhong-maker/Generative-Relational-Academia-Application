...
``web_application/packages/protocol``. They must agree on every identifier for every input,
...
Run from the academia directory: python domain_packages/grrp/tools/make_vectors.py
"""
...
OUT = ROOT.parents[1] / "web_application" / "packages" / "protocol" / "test" / "vectors.json"
